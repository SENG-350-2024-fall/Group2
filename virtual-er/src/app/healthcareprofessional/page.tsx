...
export default function Page() {
  ...
  const [isReceptionist, setIsReceptionist] = useState(false); // set true if the user is a receptionist

  const [postingData, setPostingData] = useState(false); // is there currently a post request

  const [pageTitle, setTitle] = useState("Receptionist"); // manual page title for testing

  useEffect(() => {
    setIsReceptionist(pageTitle === "Receptionist");
  }, [pageTitle]);
...
*/
  ...
  return (
    <div className="relative min-h-screen"> {/* Ensure the container takes full height */}
      <Header title={pageTitle} ERName=" - Royal Jubilee"/>
